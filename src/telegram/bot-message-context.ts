...
export const buildTelegramMessageContext = async ({
  ...
  const { sanitizeForPrompt } = await import("../../security/prompt-injection-guard");
  ...
  const { sanitizeGroupName, sanitizeDisplayName } = await import("../../security/prompt-injection-guard");
